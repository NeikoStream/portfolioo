...
export const items: Array<Experience> = [
	...
	},
	{
		...
		links: [],
		logo: Assets.Unknown,
		shortDescription: "Passage au numérique de l'association Veracruz..."
	},
	{
		...
		logo: Assets.Unknown,
		shortDescription:
			"Stage de 12 semaines en développement web front-end et back-end (utilisant Laravel). Mission principale : refonte totale du site et création d'un logiciel de formation aux normes Qualiopi. Acquisition d'une expertise solide en développement web."
	},
	{
		slug: 'bk',
		company: 'Burger King',
